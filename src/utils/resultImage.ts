...
export function createResultImageBlob(stats: ResultStats) {
  ...
  ctx.fillStyle = "#fff";
  ctx.font = "800 42px system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif";
  ctx.fillText("PAGE(S)", 450, 120);
  ctx.font = "800 136px system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif";
  ctx.fillText(String(stats.pagesRead), 450, 250);
  ctx.font = "800 42px system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif";
  ctx.fillText("PACE", 450, 400);
  ctx.font = "800 132px system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif";
  ctx.fillText(formatTime(stats.pace), 425, 540);
  ctx.font = "800 52px system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif";
